...
describe.each([
    ...
    beforeAll(async () => {
        ...
        const msg: JettonUpdateContent = {
            ...
            jettonWalletCode: defaultContent,
        }
    ...
    it("minter admin can change content", async () => {
        ...
        await jettonMinter.sendChangeContent(deployer.getSender(), newContent, newContent)
        expect((await jettonMinter.getContent()).equals(newContent)).toBe(true)
        await jettonMinter.sendChangeContent(deployer.getSender(), defaultContent, defaultContent)
        expect((await jettonMinter.getContent()).equals(defaultContent)).toBe(true)
    })
